...
class ListenerCog(commands.Cog, name="Listener"):
    ...
    async def on_guild_join(self, guild: discord.Guild):
        ...
        d = {
            record["id"]: {"prefix": record["prefix"], "log_id": record["log_id"], "log_enabled": record["log_enabled"], "autorole": record["autorole"],
                           "welcomeMessage": record["welcomemessage"], "welcomeEnabled": record["welcomeenabled"], "welcomeId": record["welcomeid"]}
        }
