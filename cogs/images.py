...
class Images(commands.Cog):
    ...
    async def invert(self, ctx, member: discord.Member = None):
        ...
        try:
            img = await self.bot.dagpi_client.image_process(ImageFeatures.invert(), url)
    ...
    async def magik(self, ctx, member: discord.Member = None):
        ...
        url = str(member.avatar_url_as(
            format="png", static_format="png", size=1024))
        try:
            img = await self.bot.dagpi_client.image_process(ImageFeatures.magik(), url)
        except Exception as e:
            return await ctx.send(f"``` \n {e} ```")
        file = discord.File(fp=img.image, filename=f"colors.{img.format}")
        await ctx.send(embed=discord.Embed(color=0x31A1F1).set_image(url=f"attachment://colors.{img.format}"), file=file)
    ...
    async def pixel(self, ctx, member: discord.Member = None):
        ...
        url = str(member.avatar_url_as(
            format="png", static_format="png", size=1024))
        try:
            img = await self.bot.dagpi_client.image_process(ImageFeatures.pixel(), url)
        except Exception as e:
            return await ctx.send(f"``` \n {e} ```")
        file = discord.File(fp=img.image, filename=f"colors.{img.format}")
        await ctx.send(embed=discord.Embed(color=0x31A1F1).set_image(url=f"attachment://colors.{img.format}"), file=file)
    ...
    async def colors(self, ctx, member: discord.Member = None):
        ...
        url = str(member.avatar_url_as(
            format="png", static_format="png", size=1024))
        try:
            img = await self.bot.dagpi_client.image_process(ImageFeatures.colors(), url)
        except Exception as e:
            return await ctx.send(f"``` \n {e} ```")
        file = discord.File(fp=img.image, filename=f"colors.{img.format}")
        await ctx.send(embed=discord.Embed(color=0x31A1F1).set_image(url=f"attachment://colors.{img.format}"), file=file)
    ...
    async def ascii(self, ctx, member: discord.Member = None):
        ...
        url = str(member.avatar_url_as(
            format="png", static_format="png", size=1024))
        try:
            img = await self.bot.dagpi_client.image_process(ImageFeatures.ascii(), url)
        except Exception as e:
            return await ctx.send(f"``` \n {e} ```")
        file = discord.File(fp=img.image, filename=f"colors.{img.format}")
        await ctx.send(embed=discord.Embed(color=0x31A1F1).set_image(url=f"attachment://colors.{img.format}"), file=file)
    ...
    async def obama(self, ctx, member: discord.Member = None):
        ...
        url = str(member.avatar_url_as(
            format="png", static_format="png", size=1024))
        try:
            img = await self.bot.dagpi_client.image_process(ImageFeatures.obama(), url)
        except Exception as e:
            return await ctx.send(f"``` \n {e} ```")
        file = discord.File(fp=img.image, filename=f"colors.{img.format}")
        await ctx.send(embed=discord.Embed(color=0x31A1F1).set_image(url=f"attachment://colors.{img.format}"), file=file)
